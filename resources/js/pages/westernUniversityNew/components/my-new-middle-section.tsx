        ...
        <div className="bg-blue-950 dark:bg-gray-900">
            <div className="mx-auto grid max-w-screen-2xl items-center lg:grid-cols-2">
                ...
                <div className="h-full w-full px-6 py-12 text-white sm:px-10 md:p-24">
                    ...
                    <div className="prose line-clamp-2 text-gray-300" dangerouslySetInnerHTML={{ __html: outreachPrograms?.long_description }}></div>
                    ...
                    {outreachPrograms?.children?.length >= 3 && (
                        <div className='mt-6 mx-auto '><MyAllView url='outreach_programs' title='All Outreach Programs'/></div>
                    )}
                </div>
            </div>
        </div>
