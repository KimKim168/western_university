                    ...
                    {activitiesAndEvents?.children?.map((item) => (
                        <div key={item.id} className="group relative overflow-hidden bg-white shadow-lg">
                            ...
                            {/* <div className="flex h-full space-x-3 pr-4">
                                ...
                                <div className="m-4">
                                    <h2 className="font-noto-san-extra-light mb-2 line-clamp-2 text-start text-base text-red-700">
                                        {item?.title}
                                    </h2>
                                    <div className="flex items-center text-sm text-gray-600" dangerouslySetInnerHTML={{__html: item?.short_description}}>
                                    </div>
                                </div>
                            </div> */}
                             <div className="p-4">
