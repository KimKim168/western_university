        ...
        <section className="px-6 pt-16 lg:px-20">
            <div className="mx-auto grid max-w-screen-xl gap-16 lg:grid-cols-2">
                ...
                <div className="text-primary">
                    <h1 className={`mb-4 leading-tight font-bold tracking-tight text-3xl md:text-4xl ${fontClass}`}>{locale === 'kh' ? (ourHestory?.title_kh ?? ourHestory?.title) : ourHestory?.title}</h1>
