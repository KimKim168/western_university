...
const MyAllView = ({url, title}:{url:any , title:string}) => {
  return (
    <StyledWrapper className='max-w-[330px] mx-auto'>
      <Link href={`/${url}`} className="cta items-center mx-auto justify-center">
        <span className="span text-lg">{title}</span>
